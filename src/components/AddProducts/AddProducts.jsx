                        ...
                        <div className={styles.formContainer}>
                            ...
                            <form encType="multipart/form-data" className={styles.addProductsForm} onSubmit={handleSubmit}>
                                <div className={styles.formList}>
                                    ...
                                    <input type="text" name="name" value={product.name} onChange={handleChange} placeholder="Masukkan nama produk" />
                                </div>
                                <div className={styles.formList}>
                                ...
                                <div className={styles.formList}>
                                    ...
                                    <textarea name="description" value={product.description} onChange={handleChange} placeholder="Masukkan deskripsi produk" />
                                </div>
                                <div className={styles.formList}>
                                ...
                                <div className={styles.formList}>
                                    ...
                                    <input type="number" name="price" value={product.price} onChange={handleChange} placeholder="Masukkan harga produk" />
                                </div>
                                <div className={styles.formList}>
                                ...
                                <button type="submit" style={{ maxWidth: "50%", alignSelf: 'end' }}>Add Product</button>
                            </form>
                        </div>
                        <Footer />
                    </div>
